          ...
          <div className="contact_page">
            ...
            <div className="contact_detail">
              ...
              <div className="contact_link">
                ...
                <span className="span_text">Main Branch: Office # 25 & 26 Faisal Shopping Mall Ground Floor Opp. GPO Saddar
          Rawalpindi</span>
                <span className="span_text">Branch 2:  Office # 8 Manzoor Plaza Near Tabbaq Hotel Fazal-e-Haq Road Blue Area
          Islamabad</span>
                </div>
              </div>
              ...
              <div className="contact_link">
                ...
                <span className="span_text">051 111 786 945</span>
              </div>
              {/* <div className="contact_link">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="span_bold">Email: </span>
                <span className="span_text">abc@gmail.com</span>
              </div> */}
